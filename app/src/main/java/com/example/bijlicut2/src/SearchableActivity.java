...
import com.example.bijlicut2.src.dummy.CountryActivity;
import com.example.bijlicut2.src.dummy.CountryContentProvider;
...
public class SearchableActivity extends FragmentActivity implements LoaderCallbacks<Cursor> {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("SearchableActivity", "SearchableActivity is created");
